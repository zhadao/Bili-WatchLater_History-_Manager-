# Bilibili 稍后再看 & 历史记录增强助手 (Bili-WatchLater-Ex)已停更

> **为 B 站重度用户打造的“注意力管理”与“观看体验优化”工具。**  
> 助你逃离“稍后再看”的封闭播放页，并在信息过载的时代，通过 AI 词频分析快速复盘你的近期关注点。

![License](https://img.shields.io/badge/license-MIT-blue.svg) ![Version](https://img.shields.io/badge/version-v1.5.3-green.svg)
...
---
> 作者应该不会做这个插件更多的长期更新了qaq,如果有想法可以在我这个框架上继续搭建谢谢
> 本插件暂时停止更新维护
